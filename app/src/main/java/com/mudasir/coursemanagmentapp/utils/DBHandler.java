package com.mudasir.coursemanagmentapp.utils;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String TEACHER_COL = "tracks";
    ...
    public void addNewCourse(String courseName, String courseDuration, String courseTeacher, String courseDescription) {
        ...
        values.put(TEACHER_COL, courseTeacher);
    ...
    public void updateCourse(String originalCourseName, String courseName, String courseDescription,
        ...
        values.put(DURATION_COL, courseDuration);
        values.put(DESCRIPTION_COL, courseDescription);
        values.put(TEACHER_COL, courseTracks);
